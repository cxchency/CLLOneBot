...
export class OB11GroupRequestAddEvent extends OB11BaseNoticeEvent {
  ...
  constructor(groupId: number, userId: number, flag: string, comment: string, invitor_id: number = 0, groupName?: string) {
    super()
...
export class OB11GroupRequestInviteBotEvent extends OB11BaseNoticeEvent {
  ...
  constructor(groupId: number, userId: number, flag: string, comment: string, groupName?: string) {
    super()
    this.group_id = groupId
    this.user_id = userId
    this.comment = comment
